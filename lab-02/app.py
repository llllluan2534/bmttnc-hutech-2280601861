...
def vigenere_encrypt():
    ...
    return f"text: {text}<br/>key: {key}<br/>encrypted message: {encrypted_text}"
...
def vigenere_decrypt():
    ...
    return f"text: {text}<br/>key: {key}<br/>decrypted message: {decrypted_text}"
@app.route("/railfence")
def railfence():
...
def railfence_encrypt():
    ...
    return f"text: {text}<br/>num rails: {num_rails}<br/>encrypted message: {encrypted_text}"
...
def railfence_decrypt():
    ...
    return f"text: {text}<br/>num rails: {num_rails}<br/>decrypted message: {decrypted_text}"
